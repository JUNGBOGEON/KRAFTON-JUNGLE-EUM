    ...
    if (isInMeeting) {
        return (
            <div className="flex h-screen w-full relative bg-slate-950">
                ...
                >
                    {isChatOpenInMeeting && <TranslationChat onOpenProfile={openUserProfile} onOpenMyProfile={openMyProfile} />}
                </div>
            </div>
        );
    }
                    ...
                    {currentChannel.type === 'calendar' ? (
                        ...
                        <>
                            ...
                            <div className="flex-1 relative overflow-hidden">
                                <TranslationChat onOpenProfile={openUserProfile} onOpenMyProfile={openMyProfile} />
                            </div>
                        </>
                    )}
